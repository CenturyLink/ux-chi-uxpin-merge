...
export default function UXPinWrapper({ children }) {
  if (!document.getElementById('chi-css')) {
    ...
    chiCss.setAttribute('href', 'https://assets.ctl.io/chi/5.13.0/chi-portal.css');
  ...
  if (!document.getElementById('chi-js')) {
    ...
    chiJs.setAttribute('src', 'https://assets.ctl.io/chi/5.13.0/js/chi.js');
  ...
  if (!document.getElementById('chi-ce-module')) {
    ...
    chiCeModule.setAttribute('src', 'https://assets.ctl.io/chi/5.13.0/js/ce/ux-chi-ce/ux-chi-ce.esm.js');
  ...
  if (!document.getElementById('chi-ce-nomodule')) {
    ...
    chiCeNomodule.setAttribute('src', 'https://assets.ctl.io/chi/5.13.0/js/ce/ux-chi-ce/ux-chi-ce.js');
